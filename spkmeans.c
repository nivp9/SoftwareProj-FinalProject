...
void setDataFromPython(double **iCentroid, double **idata, int ik,int iiter,int irowcount, int icolumncount);
...
double** spk(double **icentroids, double **idata, int ik,int iiter,int irowcount, int icolumncount){
  int i =0,j=0;
    ...
    setDataFromPython(icentroids, idata, ik, iiter, irowcount, icolumncount);
